                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="form_lokasi.php"><button class="btn btn-primary mb-1">Tambah Data</button></a>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td><a href='../../app/delete_lokasi.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Delete</a></td>";
                                            echo "<td><a href='../../app/update_lokasi.php?id=" . $row['id'] . "' class='btn btn-warning btn-sm'>Update</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
