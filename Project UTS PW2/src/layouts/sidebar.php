             ...
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                 <li class="nav-item">
                     ...
                     <li class="nav-item">
                             <a href="../pages/data_lokasi.php" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Data Lokasi</p>
                             </a>
                         </li>
                         <li class="nav-item">
                             <a href="../pages/data_laporan_cuaca.php" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Data Laporan Cuaca</p>
                             </a>
                         </li>
                         <li class="nav-item">
                             <a href="../pages/data_ramalan_cuaca.php" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Data Ramalan Cuaca</p>
                             </a>
                         </li>
                         <li class="nav-item">
                             <a href="../pages/data_tipe_cuaca.php" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Data Tipe Cuaca</p>
                             </a>
                         </li>
